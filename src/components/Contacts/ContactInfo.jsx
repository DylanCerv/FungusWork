    ...
    return (
        <div id='contacto' className={style.contact_container}>
            <div className='bg-green-100 flex flex-col justify-center gap-4 md:w-contact-width h-contact-height rounded-2xl px-14'>
                ...
                <span className='text-lg sm:text-md font-semibold text-black'>
            ...
            <div className='flex flex-col items-center justify-center gap-8 pb-16'>
                ...
                <div className='flex flex-col sm:flex-row justify-between gap-5'>
                    <InputText label='What’s your name?' placeholder='Full name' className='w-80 md:w-96'/>
                    <InputText label='What’s your email address?' placeholder='Email address' className='w-80 md:w-96'/>
                </div>
                <div className='flex flex-col sm:flex-row justify-between gap-5'>
                    <InputText label='What’s your phone number?' placeholder='Phone number' className='w-80 md:w-96'/>
                    <InputText label='Email subject' placeholder='Subject' className='w-80 md:w-96'/>
                </div>
